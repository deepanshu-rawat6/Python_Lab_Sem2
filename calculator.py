...
Button(SUDO, text='Quit', command=main.destroy).grid(row=4, column=0, sticky=W)
Button(SUDO, text='Add', command=add).grid(row=0, column=3, sticky=W, )
